...
class Answer:
    ...
    def __str__(self) -> str:
        return self.output_vid_name + " " + self.logfile_name   
...
def vid_recognise(query: Query) -> Answer:
    ...
    procesessed_video_name = f"processed_{query.vid_name}"
    for person in query.persons:
...
test_persons = []
test_persons.append("Vin_Diesel")
testQuery = Query("vin_diesel_video", test_persons)

testAnswer = vid_recognise(testQuery)
